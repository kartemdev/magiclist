...
import { Form, Button, Preloader, DateTimer, InputGroup, DateTimerTypesEnum } from '~shared/ui';
...
const UserVerifieChangeEmailForm: React.FC<IProps> = ({ onSuccess }) => {
  ...
  const [updateUserData, { error, isLoading: isLoadingUpdateUserInfo }] = useUpdateUserInfo();
  ...
  return (
    ...
    >
      ...
      />
      <Button type='submit' isDisabled={isLoading || !isAllowedSendCode}>
